...
<head>
    ...
    <title>Adana multimedya montajı | <?php echo $print['siteadi']; ?></title>
...
<ul class="list-group">
<?php 
 $gelen = $db->query("SELECT * FROM hizmetler WHERE sira=2")->fetch(PDO::FETCH_ASSOC);


?>

 <a href="hizmetler.php" class="list-group-item list-group-item-action ">Adana da oto ses sistemi montajı</a>
  <a href="Adana-da-multimedya-montaji.php" class="list-group-item list-group-item-action active">Adana da multimedya montajı</a>
