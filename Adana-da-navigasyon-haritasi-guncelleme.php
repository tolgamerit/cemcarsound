...
<head>
    ...
    <title>Adana navigasyon haritası Güncelleme | <?php echo $print['siteadi']; ?></title>
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card rounded border-0" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
            <div class="card-body">
                <h4 class="card-title p-3">Hizmetlerimiz</h4>
                <div class="row">
<div class="col-md-4 p-5">
<ul class="list-group">
<?php 
 $gelen = $db->query("SELECT * FROM hizmetler WHERE sira=4")->fetch(PDO::FETCH_ASSOC);


?>

 <a href="hizmetler.php" class="list-group-item list-group-item-action ">Adana da oto ses sistemi montajı</a>
  ...
  <a href="Adana-da-navigasyon-haritasi-guncelleme.php" class="list-group-item list-group-item-action active">Adana da navigasyon haritası güncelleme</a>     
        </a>
...
<div class="card border-0">
  ...
  <h5><?php echo $gelen['baslik']; ?></h5>
       <h2 class="lead mt-5 mb-5 text-left">   <?php echo $gelen['icerik']; ?>
       </h2> 
  </div>
</div>
