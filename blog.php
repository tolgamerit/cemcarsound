<?php define("include",true); include("style/config.php"); include("style/functions.php"); if($print['blog']=="1"){ header("Location:".$bshrf."index.php"); exit(); } ?>
<!DOCTYPE HTML>
<html lang="en-US">
<head>
<link rel="Shortcut Icon"  href="favicon.jpg"  type="image/x-icon">
	...
	<title>Blog | <?php echo $print['siteadi']; ?></title>
...
<div id="container">
  <div id="page-top">
    <div id="header-wrapper">
      <div id="header">
        <div id="logo"><a href="index<?php echo $print['uzanti']; ?>"><img src="style/images/logo.png" alt="<?php echo $print['siteadi']; ?>" /></a></div>
...
foreach($db->query("select * from blog order by id desc limit $baslangic,$limit") as $yazdir){ if($print['uzanti']==".php"){ ?>
      <div class="post">
...
<?php }elseif($print['uzanti']==".html"){ ?>
      <div class="post">
        <h2 class="title"><a href="blog/<?php echo $yazdir['seflink']; ?>.html"><?php echo $yazdir['baslik']; ?></a></h2>
        <div class="meta">
          <div class="top-border"></div>
         Yayınlanma Tarihi : <div class="date"><?php echo timeConvert($yazdir['tarih']); ?></div></div>
		 <a href="blog/<?php echo $yazdir['seflink']; ?>.html"><img src="<?php echo $yazdir['resimyolu']; ?>" alt="<?php echo $yazdir['baslik']; ?>" /></a>
        <p><?php echo htmlclean(kisalt($yazdir['icerik'], 150)); ?></p>
      </div>
<?php } } ?>
      <ul class="page-navi">
<?php if($count > $limit) :
  ...
  else echo "<li><a href=\"?page=1\">1</a></li>";
  ...
  if($page+$x < $lastP-1) {
    echo "<li><a>...</a></li>";
    echo "<li><a href=\"?page=$lastP\">$lastP</a></li>";
...
if($print['uzanti']==".php"){ echo '<meta http-equiv="refresh" content="0;URL=etiket.php?url='.$xyz.'">';
	...
	<?php }elseif($print['uzanti']==".html"){ ?>
          <li><a href="blog/<?php echo $aaa['seflink']; ?>.html"><img src="<?php echo $aaa['resimyolu']; ?>" alt="<?php echo $aaa['baslik']; ?>" /></a>
            <h4><a href="blog/<?php echo $aaa['seflink']; ?>.html"><?php echo $aaa['baslik']; ?></a></h4>
            <span class="info"><?php echo timeConvert($aaa['tarih']); ?></span></li>
		<?php } } ?>
        </ul>
      </div>
	...
	if($print['uzanti']==".php"){ echo '<li><a href="etiket.php?url='.$acayip.'">'.$etiket.'</a></li>'; }elseif($print['uzanti']==".html"){ echo '<li><a href="etiket/'.$acayip.'/">'.$etiket.'</a></li>'; } } } ?>
        </ul>
      </div>
    </div>
  </div>
...
<link rel="stylesheet" media="all" href="style/type/<?php $print['tfont']; ?>" />
<!--[if IE 7]>
