...
<head>
    ...
    <title>Hakkımızda | <?php echo $print['siteadi']; ?></title>
...
<body>
    ...
    $gelen = $db->query("SELECT * FROM sayfalar WHERE seflink='hakkimizda'")->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <h6 class="card-text lead mt-5 mb-5 text-left">
                            <p>Cem Car Sound ailesi olarak 1986 yılından bu yana oto ses ve görüntü sistemleri üzerine Adana'da siz değerli müşterilerimize hizmet vermekteyiz.
                            </P>
                            <p>Hizmet kalitesi ve güvenilirliğimizi üst seviyeleri taşıyabilmek için çağımızın gereksinimi olan yeniden yapılanmaya adım atmış bulunmaktayız.
                            </p>
                            <p>Bu doğrultuda müşteri talep ve beklentileri bizim için önem taşımaktadır. Yeni veya eski olsun aracınız bizim için çok önemlidir.Konusunda uzman güleryüzlü ekibimizle sizleri bekliyoruz.
                            </p>
                            <p>Oto teyp, DVD, Navigasyon, Kamera ve Oto Ses Sistemleri tamir, satış ve montaj hizmetini en iyi şekilde vermekteyiz. Türkiye'nin kurumsal firmaları ile bayii olarak çalışarak güncel ve kaliteli ürün tedariği yapmaktayız.</p>
                            <p> Hizmet verdiğimiz gerek satış gerek montaj işlerinde garantimizin sonuna kadar arkasında olup memnuniyetsizlik olması durumunda yasal olan tüketici haklarına uymaktayız.</p>
                            <p>Hedefimiz müşteri kitlemizi koruyarak ve yeniliklere ayak uydurup müşteri beklentilerini en üst seviyede karşılamaktır.</p>
<strong>Cem Car Sound</strong>
                        </h6>
