...
<div class="col-md-3">
<div class="row ml-2">
<?php if($gelen['resim1']==""){ }else{ ?>

<div class="card border-0">
  <img style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="card-img-top rounded " src="<?php echo $gelen['resim1']; ?>" alt="<?php echo $gelen['baslik']; ?>">
  </div> 
<?php ?>
<?php if($gelen['resim2']==""){ }else{ ?>

  <div class="card border-0 mt-5">
  <img style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="card-img-top rounded " src="<?php echo $gelen['resim2']; ?>" alt="<?php echo $gelen['baslik']; ?>">
  </div>  
<?php }?>
...
<div class="col-md-9 p-5">   <h4><?php echo $gelen['baslik']; ?></h4>
		<p>
