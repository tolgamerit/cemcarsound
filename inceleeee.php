<?php define("include",true); include("style/config.php"); include("style/functions.php"); $url = htmlentities(htmlclean($_GET['url'])); if($print['incele']=="1"){ header("Location:".$bshrf."index.php"); exit(); }
...
<a target="_blank" href="https://www.instagram.com/cemcarsound/"><img src="png-logo/instagram.png" align="right"> </a>
  ...
  <div id="wrapper">
    <div>
      <div class="image"><?php if($gelen['resim1']==""){ }else{ ?><img height="350" width="400" src="<?php echo $gelen['resim1']; ?>" alt="<?php echo $gelen['baslik']; ?>" /><?php } ?>
	<?php if($gelen['resim2']==""){ }else{ ?><img height="350" width="400" src="<?php echo $gelen['resim2']; ?>" alt="<?php echo $gelen['baslik']; ?>" /><?php } ?></div>
