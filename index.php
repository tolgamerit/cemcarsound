...
<body>
    ...
    <div id="carouselExampleControls" class="carousel slide container mt-5 mb-5" data-ride="carousel">
        <div style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="carousel-inner rounded">
            <div class="carousel-item active">
                <img class="d-block w-100" src="resimler/slider0.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="resimler/slider1.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="resimler/slider2.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="resimler/slider3.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="resimler/slider4.jpg" alt="Third slide">
            </div>
        </div>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card rounded border-0" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
            <div class="card-body">
                <h3 class="card-title p-3 text-center"> YAPTIĞIMIZ İŞLER </h3>
                <div class="row ">


                    <div class="col-md-6  mb-3 mt-3">
                        <div class="rounded mx-auto d-block shadow  embed-responsive embed-responsive-16by9" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card rounded border-0" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
            <div class="card-body">
                <h3 class="card-title p-3 text-center"> MARKALAR </h3>
                <div class="row p-3">
                    <?php foreach ($db->query("select * from bloks order by id asc") as $bbb) { ?>
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-3"><img style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="img-fluid rounded mx-auto d-block  mt-3 mr-2" src="<?php echo $bbb['resimyolu']; ?>" alt="<?php echo $bbb['baslik']; ?>" />
    ...
    <div class="container-fluid fixed-row-bottom ">
        ...
        <div style="background-color:#6ec7e0" class="row p-5">
            ...
            <div class="col-md-12 ">
                ...
                <p class="text-center text-white ">&copy; <?php date_default_timezone_set('Europe/Istanbul');
