...
<head>
    ...
    <title>Modeller | <?php echo $print['siteadi']; ?></title>
   ...
   ?>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="card rounded border-0" style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)">
            <div class="card-body">
                <h4 class="card-title p-3"> Araç Markaları</h4>
                <div class="row p-5">

<?php $gelen= $_GET[url]; foreach($db->query("select * from projeler where kategori='".$gelen."'") as $bbb){?>
    <div class="col-lg-3 col-md-4 col-sm-6">

<a href="urun.php?url=<?php echo $bbb['seflink']; ?>"><img style="box-shadow: 0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" class="img-fluid rounded mx-auto d-block shadow- mt-3 mr-2" src="<?php echo $bbb['resimyolu']; ?>" alt="<?php echo $bbb['marka']; ?>" /></a>
</div>
<?php }?>
