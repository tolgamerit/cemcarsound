...
$kayit = $db->prepare("update pkat SET sira=?,baslik=?,seflink=?,resimyolu=? where id=?"); $kayit->execute(array($sira, $baslik, $url, $resim, $id ));

echo "<div class='done msg' style='width:200px;'><b>Düzenleme kaydedildi.</b></div><br>"; } } ?>
						<form method="post">
				<?php foreach($db->query("select * from pkat where id='$id'") as $aaa){ ?>
						<div class="col50">
...
<label><b>Resim Yolu</b></label><br>
						<input type="text" size="70" name="resim" value="<?php echo $aaa['resimyolu']; ?>" class="input-text" /><br><br>								
				</p>
