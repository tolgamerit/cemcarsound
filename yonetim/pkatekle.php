...
$kayit = $db->prepare("insert into pkat SET sira=?,baslik=?,seflink=?, resimyolu=?"); $kayit->execute(array($sira, $baslik, $url,$resim));

echo "<div class='done msg' style='width:200px;'><b>Ürün Markası eklendi.</b></div><br>"; } } ?>
						<form method="post">
			...
			<p class="t-justify">   
						...
						<label><b>Marka Resmi</b> (225x150)</label> <a onclick="window.open('/upload/upload.php','Upload','width=500,height=200,scrollbars=1');return false;" href="">Resim Yükle</a><br>
