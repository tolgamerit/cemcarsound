...
$kayit = $db->prepare("insert into projeler SET baslik=?,resimyolu=?,kategori=?,seflink=?"); 
$kayit->execute(array($baslik,$resimyolu, $kategori, $url));
...
echo "<div class='done msg' style='width:200px;'><b>Ürün eklendi.</b></div><br>"; } } ?>
			...
			<p class="t-justify">   
						...
						<label><b>Ürün Markası</b></label><br>
