...
$kayit = $db->prepare("insert into sayfalar SET sira=?,baslik=?,keywords=?,description=?,kategori=?,icerik=?,seflink=?"); 
$kayit->execute(array($sira, $baslik, $keywords, $description, $kategori, $icerik, $url));

echo "<div class='done msg' style='width:200px;'><b>Sayfa eklendi.</b></div><br>"; } } ?>
						<form method="post">
