...
<?php include("css/menu2.php"); ?>
		...
		<div id="content" class="box">
			<h1>Sayfa Kategorisi Düzenle</h1><br>
...
$kayit = $db->prepare("update skat SET sira=?,baslik=?,seflink=? where id=?"); $kayit->execute(array($sira, $baslik, $url, $id));

echo "<div class='done msg' style='width:200px;'><b>Düzenleme kaydedildi.</b></div><br>"; } } ?>
						<form method="post">
				<?php foreach($db->query("select * from skat where id='$id'") as $aaa){ ?>
						<div class="col50">
