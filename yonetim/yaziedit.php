...
if($baslik==""||$keywords==""||$description==""||$resimyolu==""||$icerik==""){ echo '<div class="error msg" style="width:300px;"><b>Bütün alanları doldurmanız gerekmektedir.</b></div><br>'; }else{

$kayit = $db->prepare("update blog SET baslik=?,keywords=?,description=?,resimyolu=?,icerik=?,seflink=? where id=?"); 
$kayit->execute(array($baslik, $keywords, $description, $resimyolu, $icerik, $url, $id));
...
echo "<div class='done msg' style='width:200px;'><b>Düzenleme kaydedildi.</b></div><br>"; } } ?>
				...
				<p class="t-justify">   
						...
						<input type="text" size="70" name="baslik" value="<?php echo $aaa['baslik']; ?>" class="input-text" /><br><br>
						...
						<label><b>Resim</b> (600x300)</label> <a onclick="window.open('/upload/upload.php','Upload','width=500,height=200,scrollbars=1');return false;" href="">Resim Yükle</a><br>
