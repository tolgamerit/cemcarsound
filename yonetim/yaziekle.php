...
$kayit = $db->prepare("insert into blog SET baslik=?,keywords=?,description=?,resimyolu=?,icerik=?,tarih=?,seflink=?"); 
$kayit->execute(array($baslik, $keywords, $description, $resimyolu, $icerik, $tarih, $url));

echo "<div class='done msg' style='width:200px;'><b>Yazı eklendi.</b></div><br>"; } } ?>
						<form method="post">
							<div class="col50">
